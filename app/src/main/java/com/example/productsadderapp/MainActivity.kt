package com.example.productsadderapp
...
import com.example.productsadderapp.databinding.ActivityMainBinding
    ...
    private fun saveProduct() {
        ...
        lifecycleScope.launch(Dispatchers.IO){
                ...
                async {
                    imagesByteArrays.forEach {
                        ...
                        launch {
                            ...
                            val dowloadUrl = result.storage.downloadUrl.await().toString()
            ...
            firestore.collection("Products").add(product).addOnSuccessListener {
                hideLoading()
                Toast.makeText(this@MainActivity,"Success Products",Toast.LENGTH_SHORT).show()
